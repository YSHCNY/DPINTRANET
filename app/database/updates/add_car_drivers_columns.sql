ALTER TABLE car_drivers
  ADD COLUMN employee_id VARCHAR(30) NOT NULL UNIQUE AFTER id,
  ...
  ADD COLUMN license_number VARCHAR(50) NOT NULL UNIQUE AFTER email,
  ADD COLUMN license_class VARCHAR(20) NOT NULL AFTER license_number,
  ADD COLUMN license_expiry DATE NOT NULL AFTER license_class;
