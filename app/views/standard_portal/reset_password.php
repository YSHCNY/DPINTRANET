        ...
        <div class="w-full overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm">
            <div class="border-b border-slate-200 px-6 py-5 sm:px-8">
                ...
                <p class="mt-2 text-sm leading-6 text-slate-600">
                    Create a new password for your account and sign in with it immediately afterward.
                </p>
            </div>

            <form method="POST" action="index.php?controller=StandardPortal&action=resetPassword" class="space-y-4 p-6 sm:px-8 sm:py-7">
