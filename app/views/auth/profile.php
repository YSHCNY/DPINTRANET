...
<div class="min-h-screen bg-gray-50">
  <div class="mx-auto max-w-6xl px-4 py-6 sm:px-5 sm:py-6">
    <div class="mb-6 overflow-hidden rounded-[32px] border border-slate-200 bg-white shadow-[0_18px_60px_rgba(15,23,42,0.08)]">
      <div class="border-b border-slate-200 bg-gradient-to-r from-slate-50 via-white to-slate-50 px-5 py-4">
          ...
          <div class="grid grid-cols-1 lg:grid-cols-[320px_minmax(0,1fr)] gap-5">
            <aside class="space-y-3">
              <div class="overflow-hidden rounded-[28px] border border-slate-200 bg-white shadow-sm">
                <div class="bg-gradient-to-br from-sky-600 via-sky-500 to-cyan-500 px-5 py-5 text-white">
                ...
                <div class="space-y-3 p-4">
                  ...
                  <div class="rounded-3xl border border-dashed border-slate-300 bg-slate-50 px-4 py-4 text-center transition hover:border-sky-300 hover:bg-sky-50/60" id="avatarDropZone">
              ...
              <div class="rounded-[28px] border border-slate-200 bg-slate-50 p-4 shadow-sm">
            ...
            <section class="space-y-5">
                ...
                <div class="mt-4 grid grid-cols-1 md:grid-cols-2 gap-3">
                  <div>
                    ...
                    <input type="text" value="<?= htmlspecialchars($user['firstName'] ?? '') ?>" readonly
                           class="w-full h-10 rounded-2xl border border-slate-200 bg-slate-50 px-4 text-sm text-slate-700 outline-none">
                  </div>
                  <div>
              ...
              <div class="rounded-[28px] border border-slate-200 bg-slate-50/70 p-4 shadow-sm">
                ...
                <div class="mt-4 grid grid-cols-1 md:grid-cols-3 gap-3">
                  <div class="md:col-span-3">
                    ...
                    <input type="password" name="current_password" autocomplete="current-password"
                           class="w-full h-10 rounded-2xl border border-slate-200 bg-white px-4 text-sm text-slate-700 outline-none transition focus:border-sky-500 focus:ring-2 focus:ring-sky-100">
                  </div>
                  <div>
              ...
              <div class="flex flex-col-reverse gap-3 sm:flex-row sm:justify-end">
                ...
                <button type="submit"
                        class="inline-flex items-center justify-center rounded-2xl bg-sky-600 px-4 py-3 text-sm font-semibold text-white transition hover:bg-sky-700">
